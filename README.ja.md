...
- **チェックイン** — Web の QR スキャナー（あらゆる USB／Bluetooth バッジスキャナーで動作するテキスト入力欄と、任意のカメラスキャン）が出席を記録します。カメラでのスキャンに成功すると、プレビューが緑色に光りチェックマークが表示され、短い（ミュート可能な）ビープ音が鳴ります。Moodle アプリ内でも動作します。出席の記録が行われると修了証が取得可能になります。
