...
$string['addtogroup'] = 'チケット保有者をグループに追加';
$string['addtogroup_help'] = 'この種別のチケットが発行されたユーザーは全員、選択したコースグループに追加されます。';
$string['addtogroupheader'] = 'グループへの追加';
$string['addtogroupheader_help'] = 'この種別のチケットが発行された時点（購入・無料発行・プロモコード引き換え・自動付与のいずれでも）で、ユーザーを自動的にコースグループに追加します。上の「自動付与」とは逆方向で、そちらはグループ所属からチケットを付与するものです。既にそのグループに所属している場合は何も変わりません。後でグループを抜けてもチケットは取り消されず、チケットを失ってもグループから外れません。';
...
$string['cameraerror'] = 'カメラにアクセスできませんでした。';
$string['cameraerror_denied'] = 'カメラへのアクセスが拒否されました。ブラウザ／サイトのカメラ権限設定を確認し、ページを再読み込みしてください。';
$string['cameraerror_insecurecontext'] = 'カメラスキャナーの利用には安全な接続（HTTPS）が必要です。';
$string['cameraerror_notfound'] = 'この端末ではカメラが見つかりませんでした。';
$string['cameraerror_notsupported'] = 'このブラウザはカメラへのアクセスに対応していません。';
$string['capacity'] = '定員';
$string['capacity_help'] = 'この種別のチケットを発行できる最大数です。上限を設けない場合は空欄にしてください。';
$string['certificate'] = '修了証';
$string['checkedin'] = 'チェックインしました';
$string['checkin'] = 'チェックイン';
$string['checkinreport'] = 'チェックインレポート';
$string['checkinreport_help'] = '受講登録済みの参加者全員について、このインスタンスでのチケット保有状況とチェックイン状況を表示します。まだチェックインしていない人や、チケットを保有していない人も含まれます。';
$string['checkintime'] = 'チェックイン日時';
...
$string['confcheckin:viewreport'] = 'チェックインレポートを閲覧する';
$string['confirmdeletepromocode'] = 'プロモコード「{$a}」を削除しますか？ 既にこのコードで発行されたチケットには影響しません。';
$string['confirmdeletetickettype'] = 'チケット種別「{$a->name}」を削除しますか？ 紐づくプロモコード {$a->promocodes} 件も一緒に削除されます。既に発行された {$a->tickets} 件のチケットには影響しません。';
...
$string['currency'] = '通貨';
$string['defaulttemplate:attended'] = '{$a} に参加したことを証明します';
$string['defaulttemplate:certificatetitle'] = '参加証明書';
$string['defaulttemplate:certifiesthat'] = '下記の者は';
$string['defaulttemplate:cost'] = '金額：{$a}';
$string['defaulttemplate:origin'] = '取得方法：{$a}';
$string['defaulttemplate:receiptfor'] = '領収書宛名：{$a}';
$string['defaulttemplate:tickettype'] = 'チケットタイプ：{$a}';
$string['deletedgroup'] = '（削除されたグループ）';
...
$string['eligibilityenrol'] = '登録方法を必須にする';
$string['eligibilityenrol_help'] = 'このチケット種別を、選択した登録方法でこのコースに登録されているユーザーのみが購入・取得できるように制限します。下の「グループメンバーシップを必須にする」とはどちらか一方のみ選択してください。';
$string['eligibilityenrolvalue'] = '登録方法: {$a}';
$string['eligibilitygroup'] = 'グループメンバーシップを必須にする';
$string['eligibilitygroup_help'] = 'このチケット種別を、選択したコースグループのメンバーのみが購入・取得できるように制限します。「登録方法を必須にする」とはどちらか一方のみ選択してください。';
$string['eligibilitygroupvalue'] = 'グループ: {$a}';
$string['eligibilityheader'] = '購入資格';
$string['eligibilityheader_help'] = '必要に応じて、このチケット種別を購入・取得できるユーザーを、特定のコースグループのメンバー、または特定の登録方法で登録されたユーザーに制限できます。上の「自動付与」（自動的にチケットを発行するもので、セルフサービス購入を制限するものではありません）とは別の仕組みです。プロモコードによる引き換えは、上の「発表者限定」と同様に、この制限を完全に回避します。';
...
$string['error:eligibilityexclusive'] = 'グループによる制限か登録方法による制限のどちらか一方のみを選択してください。両方は選択できません。';
$string['error:fractionalzerodecimal'] = 'この通貨は小数を使用しません。整数で入力してください（例：500.50 ではなく 500）。';
...
$string['error:invalidmaxperuser'] = 'ユーザーごとの最大チケット枚数は1以上の整数を入力するか、無制限にする場合は空欄にしてください。';
...
$string['error:maxperuserexceeded'] = 'このチケット種別について、既に保有できる上限枚数に達しています。';
...
$string['error:notavailable'] = 'このチケット種別は現在取得できません。';
$string['error:noteligible'] = 'このチケット種別を購入・取得する資格がありません。';
...
$string['maxperuser'] = 'ユーザーごとの最大チケット枚数';
$string['maxperuser_help'] = '1人のユーザーが同時に保有できる、このチケット種別のチケットの最大枚数です。無制限にする場合は空欄のままにしてください。';
$string['maxperuserreached'] = '上限に達しています';
...
$string['mutescansound'] = '音を消す';
$string['mytickets'] = 'あなたのチケット';
$string['noenrolledusers'] = '受講登録済みのユーザーが見つかりません。';
...
$string['noqrdecodersupport'] = 'このブラウザにはカメラがありますが、QRコードを解析する方法がありません。';
$string['noticketheld'] = 'チケットなし';
...
$string['presentationinfoformat'] = '発表情報のフォーマット';
$string['presentationinfoformat_help'] = 'このテンプレート種別で [[presentationinfo]] に何がどのように表示されるかを制御します。このフォーマットは、対象の発表者が発表する採択済み応募ごとに1回ずつ適用され、改行で連結されます。{title} や {track}（上記の [[ ]] プレースホルダー区切り記号とは異なる、単一の中括弧であることに注意）をその中で使用できます。例: "<strong>{title}</strong>（{track}）"。空欄のままにすると、タイトルのみが表示されます。トラックが設定されていない応募では {track} は空欄になるため、その周りに固定で入力した「（...）」は空の括弧として表示されます。';
...
$string['privacy:metadata:confcheckin_ticket:origin'] = 'チケットの取得方法（購入・無料・プロモコード・自動付与）。';
$string['privacy:metadata:confcheckin_ticket:promocodeid'] = 'このチケットに使用されたプロモコード（ある場合）。';
$string['privacy:metadata:confcheckin_ticket:qrtoken'] = 'このチケットのQRコードを識別する一意のトークン。';
$string['privacy:metadata:confcheckin_ticket:tickettypeid'] = 'このチケットが発行されたチケット種別。';
...
$string['removecheckin'] = 'チェックインを取り消す';
...
$string['scancheckin_help'] = 'カメラを出席者のQRコード付きチケットに向けると、チェックインが記録されます。この端末に複数のカメラがある場合は、使用するカメラをドロップダウンから選択できます。';
$string['scanning'] = '確認中...';
$string['scannoscript'] = 'QRコードをスキャンするには、このページでJavaScriptを有効にする必要があります。';
$string['scanwithcamera'] = 'カメラ';
$string['selectcamera'] = 'カメラを選択';
$string['showavailability'] = '取得可能期間をユーザーに表示する';
$string['showavailability_help'] = '下記の「取得開始日」「取得終了日」を購入ページでユーザーに表示するかどうかです。オフにすると、取得可能期間外のチケット種別は具体的な日付を表示せず「現在取得できません」とだけ表示されます——後日発表するキャンペーン期間などに便利です。';
$string['soldout'] = '完売';
...
$string['uses'] = '利用回数';
$string['validfrom'] = '取得開始日';
$string['validfrom_help'] = 'このチケット種別を購入・取得できるようになる日付です。空欄の場合、開始日の制限はありません。早割チケットのようなキャンペーンに便利です。';
$string['validfromdate'] = '{$a}から取得可能。';
$string['validto'] = '取得終了日';
$string['validto_help'] = 'この日付以降、このチケット種別は購入・取得できなくなります。空欄の場合、終了日の制限はありません。';
$string['validtodate'] = '{$a}まで取得可能。';
$string['visible'] = '表示';
