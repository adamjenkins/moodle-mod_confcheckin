...
$string['scaffoldnoticecheckin'] = 'QRチェックインスキャナーおよび参加証明書は現在準備中です。';
$string['soldout'] = '完売';
$string['sortorder'] = '表示順';
$string['templatecontent'] = 'テンプレート内容';
$string['templatecontent_help'] = '利用可能なプレースホルダー: {{fullname}}、{{email}}、{{tickettype}}、{{confcheckinname}}、{{origin}}、{{qrcode}}（参加者固有のQRコード）、および対象資格のある発表者の場合のみ {{submissiontitle}}、{{track}}（発表者でない場合は空欄）。認識されないプレースホルダーは、PDF生成時に単純に削除されます。';
$string['templateplaceholders'] = '利用可能なプレースホルダー: {{fullname}}、{{email}}、{{tickettype}}、{{confcheckinname}}、{{origin}}、{{qrcode}}、および対象資格のある発表者の場合のみ {{submissiontitle}}、{{track}}。';
