...
$string['cameraerror'] = 'Could not access the camera.';
$string['cameraerror_denied'] = 'Camera access was denied. Check this browser/site\'s camera permission setting and reload the page.';
$string['cameraerror_insecurecontext'] = 'The camera scanner requires a secure (HTTPS) connection.';
$string['cameraerror_notfound'] = 'No camera could be found on this device.';
$string['cameraerror_notsupported'] = 'This browser does not support camera access.';
...
$string['confirmdeletetickettype'] = 'Delete the ticket type "{$a->name}"? Its {$a->promocodes} promo code(s) will be deleted with it; the {$a->tickets} ticket(s) already issued for it are not affected.';
...
$string['defaulttemplate:attended'] = 'attended {$a}';
$string['defaulttemplate:certificatetitle'] = 'Certificate of Attendance';
$string['defaulttemplate:certifiesthat'] = 'This certifies that';
$string['defaulttemplate:cost'] = 'Amount: {$a}';
$string['defaulttemplate:origin'] = 'How obtained: {$a}';
$string['defaulttemplate:receiptfor'] = 'Receipt for: {$a}';
$string['defaulttemplate:tickettype'] = 'Ticket type: {$a}';
...
$string['error:fractionalzerodecimal'] = 'This currency does not use decimal places -- enter a whole number (e.g. 500, not 500.50).';
...
$string['error:notavailable'] = 'This ticket type is not currently available.';
...
$string['noqrdecodersupport'] = 'This browser has a camera, but no way to decode QR codes from it.';
...
$string['privacy:metadata:confcheckin_ticket:origin'] = 'How the ticket was obtained: purchase, free, promo, or grant.';
$string['privacy:metadata:confcheckin_ticket:promocodeid'] = 'The promo code redeemed for this ticket, if any.';
$string['privacy:metadata:confcheckin_ticket:qrtoken'] = 'The unique token identifying this ticket\'s QR code.';
$string['privacy:metadata:confcheckin_ticket:tickettypeid'] = 'The ticket type this ticket was issued for.';
...
$string['scancheckin_help'] = 'Point the camera at an attendee\'s QR-coded ticket to record their check-in. If more than one camera is available on this device, a dropdown lets you choose which one to use.';
$string['scanning'] = 'Checking...';
$string['scannoscript'] = 'This page needs JavaScript enabled to scan QR codes.';
$string['scanwithcamera'] = 'Camera';
$string['selectcamera'] = 'Select camera';
$string['showavailability'] = 'Show availability window to users';
$string['showavailability_help'] = 'Whether the "Available from"/"Available until" dates below are shown to users on the purchase page. When off, a ticket type outside its availability window simply shows as "not currently available", without revealing the actual dates -- useful for a surprise/announced-later campaign window.';
...
$string['uses'] = 'Uses';
$string['validfrom'] = 'Available from';
$string['validfrom_help'] = 'The date this ticket type can first be purchased/claimed from. Leave blank for no start restriction. Useful for campaigns like early-bird tickets.';
$string['validfromdate'] = 'Available from {$a}.';
$string['validto'] = 'Available until';
$string['validto_help'] = 'The date after which this ticket type can no longer be purchased/claimed. Leave blank for no end restriction.';
$string['validtodate'] = 'Available until {$a}.';
